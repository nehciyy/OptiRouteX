...
csv_file_path = os.path.join(data_folder_path, 'generation_results_pop5_gen10_test_10_traffic.csv')
best_route_csv_path = os.path.join(data_folder_path, 'best_route_pop5_gen10_test_10_traffic.csv')
